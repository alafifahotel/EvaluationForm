...
export const specificCriteria = {
  reception: [
    {
      id: "pms",
      label: "Maîtrise du PMS (Orchestra) et exactitude des saisies",
      description: "Maîtrise du logiciel, check-in/check-out",
    },
    {
      id: "vip",
      label: "Qualité de l’accueil et du check-in",
    ...
    {
      id: "communication_deps",
      label: "Qualité de communication avec les autres départements",
      description: "Transmission d'informations, coordination efficace",
    },
  ],
  housekeeping: [
    {
    ...
    {
      id: "espaces_communs",
      label: "Entretien des espaces communs",
      description: "Propreté et organisation des zones communes",
    },
  ],
  restauration: [
    {
    ...
    {
      id: "coordination_cuisine_bar",
      label: "Coordination avec la cuisine et le bar",
      description: "Communication fluide, synchronisation du service",
    },
  ],
  cuisine: [
    {
    ...
    {
      id: "fiches_techniques",
      label: "Respect des fiches techniques",
      description: "Quantités, dressage, standards de l'hôtel",
    },
  ],
  maintenance: [
    {
  ...
  equipiers: [
    ...
    {
      id: "communication_efficace",
      label: "Communication efficace",
      description: "Échange d'informations, coordination avec collègues",
    },
  ],
  plongeurs: [
    {
...
export const supervisorAppreciationScale = [
  {
    ...
    bonusEligible: "Prime maximale",
  },
  {
    min: 80,
    max: 89,
    label: "Très bonne performance",
    color: "text-blue-600",
    bonusEligible: "Prime standard",
  },
  {
    min: 70,
    max: 79,
  ...
  },
  {
    ...
    bonusEligible: "Pas de prime",
  },
  {
    min: 0,
    max: 59,
    label: "Performance insuffisante",
    color: "text-red-600",
    bonusEligible: "Pas de prime",
  },
];
