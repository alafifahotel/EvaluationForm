...
function AddPositionModal({ isOpen, onClose, onAdd, parentPosition }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    if (position.trim()) {
      onAdd(position.trim(), title.trim())
      onClose()
    }
  }
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-xl w-full max-w-md mx-4 p-6">
        ...
        {/* Header */}
        <div className="mb-6">
          <h3 className="text-lg font-bold text-gray-800">Ajouter un poste</h3>
