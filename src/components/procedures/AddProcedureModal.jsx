...
function AddProcedureModal({ isOpen, onClose, departmentId }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    if (form.title.trim() && departmentId) {
      const procedure = {
      ...
      addProcedure(departmentId, procedure)
      onClose()
    }
  }
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto py-4">
      ...
      <div className="relative bg-white rounded-xl shadow-xl w-full max-w-2xl mx-4 p-6 max-h-[90vh] overflow-y-auto">
        ...
        <div className="mb-6">
          <h3 className="text-lg font-bold text-gray-800">Ajouter une procédure</h3>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Ex: CHECK-IN CLIENT"
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500"
                rows={2}
                placeholder="Décrire l'objectif de la procédure..."
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500"
                  placeholder="Ex: Réceptionnistes"
                />
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500"
                  placeholder="Ex: Fiche client, PMS"
                />
              </div>
